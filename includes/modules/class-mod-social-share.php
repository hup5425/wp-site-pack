...
class WSP_Mod_Social_Share extends WSP_Module {
	...
	protected function icon_svg( $net ) {
		...
		// 네이버 블로그: 초록 "b|" (실제 로고). 흰 버튼에 초록 마크(고정색).
		if ( 'naver_blog' === $net ) {
			return '<svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><text x="5.5" y="18" font-size="17" font-weight="900" fill="#03c75a" font-family="Arial,Helvetica,sans-serif">b</text><rect x="15" y="6" width="2.6" height="12" rx="1.3" fill="#03c75a"/></svg>';
		}
		// 네이버 카페: 초록 커피잔 + 잎 (실제 로고).
		if ( 'naver_cafe' === $net ) {
			return '<svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><path fill="#03c75a" d="M4 9.8h10.5v4.7A4.5 4.5 0 0 1 10 19H8.5A4.5 4.5 0 0 1 4 14.5V9.8z"/><path fill="#03c75a" d="M14.5 10.6H16a2.6 2.6 0 0 1 0 5.2h-1.5v-1.9H16a.7.7 0 0 0 0-1.4h-1.5z"/><path fill="#03c75a" d="M10.8 8.6C9.2 7.8 8.5 5.9 9.3 4c1.9.5 2.8 2.3 2.1 4.1-.2.2-.4.3-.6.5z"/></svg>';
		}
		$p = array(
