 ...
 * Description: 모듈형 사이트 운영 유틸리티 팩. 헤더/푸터, 예약글 발행 보장, 자동 인덱싱(IndexNow), Ads 매니저, 소셜 공유, 관련 글, 스마트 스크롤 팝업, 애드 프로텍터, SEO(Rank Math 대체), 소유 확인·분석 코드를 모듈 On/Off 로 제공합니다.
 * Version: 0.4.8
 * Author: You
 * License: GPL-2.0+
