...
// 예약 발행 글: 7/09 에 써 두고 7/24 에 발행 → 수정 시각이 발행보다 앞선다(ctrla 실측). 늦은 쪽(발행)을 낸다.
$예약글 = (object) array(
	'post_date'         => '2026-07-24 19:48:43',
	'post_date_gmt'     => '2026-07-24 10:48:43',
	'post_modified'     => '2026-07-09 20:40:40',
	'post_modified_gmt' => '2026-07-09 11:40:40',
);
확인( '예약 발행 글의 수정 시각은 발행 시각보다 이르지 않다', WSP_SEO_Head::modified_iso( $예약글 ), '2026-07-24T19:48:43+09:00' );
확인( '예약 발행 글의 발행 시각은 그대로', WSP_SEO_Head::published_iso( $예약글 ), '2026-07-24T19:48:43+09:00' );
